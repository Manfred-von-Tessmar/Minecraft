...
public class MrGlowstoneBiome extends ProkektModElements.ModElement {
	public static Biome biome;
	public MrGlowstoneBiome(ProkektModElements instance) {
		super(instance, 28);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-13421569).setWaterColor(-6750055).setWaterFogColor(-16777063)
						.withSkyColor(-13421569).withFoliageColor(-16711783).withGrassColor(-10027264).build();
				...
				event.getRegistry().register(biome.setRegistryName("prokekt:mr_glowstone"));
			}
		}
	}
	@Override
